    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="font-headline text-2xl font-bold text-red-400">
            SUSCRIPCIÓN EXPIRADA
          </h1>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Tu período de acceso a <span className="text-white font-bold">NeuroTrade</span> ha finalizado.
            Para renovar tu suscripción y recuperar el acceso, por favor contacta al administrador del sistema.
          </p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 space-y-3 text-left">
          ...
          <ul className="space-y-2">
            {[
              'Contacta a tu administrador para renovar tu plan.',
              'Una vez renovada, tu acceso se restaurará automáticamente.',
              'Tus datos y configuraciones están seguros y se conservarán.',
            ].map((item, i) => (
